            ...
            <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-8 px-6 lg:flex-row lg:items-center lg:gap-16">
                <div className="flex flex-1 flex-col gap-4">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <Link to="/signup" className="rounded-lg bg-blue-600 px-6 py-3 text-white shadow-lg transition hover:bg-blue-700">
                            Get Started Free
                        </Link>
                        <Link to="/signin" className="rounded-lg border border-slate-300 px-6 py-3 text-slate-700 transition hover:bg-slate-100">
                            Sign In
                        </Link>
                    </div>
                </div>
